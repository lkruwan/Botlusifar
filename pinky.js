...
module.exports = {
 ...
 OA_NAME: process.env.Z_DEP_NAME === undefined ? 'ks' : process.env.Z_DEP_NAME,
 ...
 OA_REPLY: process.env.Z_DEP_REPLY === undefined ? 'you typed ks , he is my creator' : process.env.Z_DEP_REPLY,
