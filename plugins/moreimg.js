...
lusifar.addCommand({pattern: 'break ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
lusifar.addCommand({ pattern: 'pubg ?(.*)', fromMe: am,dontAddCommandList: true }, (async (message, match) => {
...
if (match[1].includes(';')) {
  ...
  lusifar.addCommand({pattern: 'phub ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   lusifar.addCommand({pattern: 'blood ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
    ...
    lusifar.addCommand({pattern: '2glitch  ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
     ...
     await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
      ...
      lusifar.addCommand({pattern: 'battle  ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  lusifar.addCommand({pattern: '1917 ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({ pattern: 'maskman?(.*)', fromMe: am,dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
         ...
         lusifar.addCommand({pattern: 'boxed ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  lusifar.addCommand({pattern: 'ffire ?(.*)', fromMe: am, dontAddCommandList: false, desc: 'add your text to random freefire logo'}, (async (message, match) => {
  ...
  lusifar.addCommand({pattern: 'window ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({pattern: 'skywal ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({pattern: 'holo ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
    ...
    lusifar.addCommand({pattern: '2ninja ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({pattern: 'drop ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({pattern: 'cloud ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 lusifar.addCommand({pattern: 'emo ?(.*)', fromMe: am, desc: 'emogi to png'}, (async (message, match) => {
    ...
    lusifar.addCommand({pattern: 'flame ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   lusifar.addCommand({pattern: 'scary ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
lusifar.addCommand({pattern: 'bld ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
