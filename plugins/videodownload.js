...
if (config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'xxxxxxx ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'xxxxxx ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
