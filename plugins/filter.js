...
if (Config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'lusifar ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
     ...
     MyPnky.addCommand({pattern: 'lusifar ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
